...
if __name__ == "__main__":
    ...
    ]  # ['bighit_official_movie'] # ['bangtantv_bangtan_bomb'] #  ['bighit_official_movie']# 'Jungkook97'] # 'Pinkkoyaa'] #'Dear_my_baby_G'] # 'bangtantv_bts_episode'] # 'KOOKIESTAETAS'] # 'bangtantv_bts_festa']
